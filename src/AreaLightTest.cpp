...
#include <stdio.h>
#include "AreaLightTest.h"

AreaLightTest::AreaLightTest (glm::vec3 pos, float lightInt):Light (pos, lightInt, "AreaLight"){
    width = 2.5;
    height = 2.5;
    numRows = 5;
    numColumns = 5;
...
AreaLightTest::AreaLightTest (glm::vec3 pos, float lightInt, bool horizontal){
    width = 2.5;
    height = 2.5;
    numRows = 5;
    numColumns = 5;
...
AreaLightTest::AreaLightTest (glm::vec3 pos, float lightInt, float angle):Light (pos, lightInt, "AreaLight"){
    width = 2.5;
    height = 2.5;
    numRows = 5;
    numColumns = 5;
...
void AreaLightTest::draw(ofColor color){
//    ofSetColor(color);
    lightArea.setPosition(getPosition());
    lightArea.setWidth(width);
    lightArea.setHeight(height);
...
bool AreaLightTest::withinLight(glm::vec3 point){
    if (isHorizontal){
...
glm::vec3 AreaLightTest::startingCell(){
    if (isHorizontal){
...
bool AreaLightTest::intersect (Ray &ray, glm::vec3 &point, glm::vec3 &normal){
...
glm::vec3 AreaLightTest::getCellPt(int row, int column){
...
int AreaLightTest::getNumRows(){
    return numRows;
}

int AreaLightTest::getNumCols(){
    return numColumns;
}

float AreaLightTest::getUnitIntensity(){
    return getIntensity() / (numRows * numColumns);
}

void AreaLightTest::setPosition (glm::vec3 pos){
